...
class BWGViewWidgetSlideshow {
  ...
  function widget($args, $instance) {
    ...
    $filmstrip_height = (isset($instance['filmstrip_height']) ? $instance['filmstrip_height'] : 40);
  ...
  function form($instance, $id_title, $name_title, $id_gallery_id, $name_gallery_id, $id_width, $name_width, $id_height, $name_height, $id_filmstrip_height, $name_filmstrip_height, $id_effect, $name_effect, $id_interval, $name_interval, $id_shuffle, $name_shuffle, $id_theme_id, $name_theme_id) {
    $defaults = array(
    ...
    <p <?php echo ($options_row->slideshow_enable_filmstrip ? '' : 'style="display: none;"'); ?>>
      <label for="<?php echo $id_filmstrip_height; ?>">Filmstrip height:</label>
