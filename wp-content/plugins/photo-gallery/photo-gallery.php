...
function bwg_options_panel() {
  ...
  $comments_page = add_submenu_page('galleries_bwg', 'Comments', 'Comments', 'manage_options', 'comments_bwg', 'bw_gallery');
...
function bw_gallery() {
  ...
  if (($page != '') && (($page == 'galleries_bwg') || ($page == 'albums_bwg') || ($page == 'tags_bwg') || ($page == 'options_bwg') || ($page == 'comments_bwg') || ($page == 'themes_bwg') || ($page == 'licensing_bwg') || ($page == 'featured_plugins_bwg') || ($page == 'uninstall_bwg') || ($page == 'BWGShortcode'))) {
...
function bwg_front_end_scripts() {
  ...
  //3D Tag Cloud.
  wp_enqueue_script('bwg_3DEngine', WD_BWG_URL . '/js/3DEngine/3DEngine.js', array(), '1.0.0');
  wp_enqueue_script('bwg_Sphere', WD_BWG_URL . '/js/3DEngine/Sphere.js', array(), '1.0.0');
}
