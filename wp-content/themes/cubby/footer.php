...
<?php }?>
 <div class="copyright">
    <div class="container">
      <div class="left wordpress"> Copyright <?php echo '&copy; ' . date("Y") ;?> <a href="<?php echo esc_url( home_url( '/' ) ); ?>"><?php bloginfo('name'); ?></a>, All Rights Reserved - <a href="wp-login.php">Admin</a>
