              ...
              <table>
                <tbody>
                  ...
                  <tr id="tr_slideshow_filmstrip_height">
                    <td class="spider_label"><label for="slideshow_filmstrip_height">Slideshow Filmstrip height: </label></td>
              ...
              <table>
                ...
                <tbody id="tbody_popup">
                  ...
                  <tr id="tr_popup_filmstrip_height">
                    <td class="spider_label"><label for="popup_filmstrip_height">Filmstrip height: </label></td>
