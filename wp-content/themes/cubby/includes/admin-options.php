...
/// HEADER
   ...
   /* $options[] = array(
		...
		$options[] = array(
		'name' =>  __('Footer Widget Background', 'cubby'),
		'id' => 'footer_widget_background',
		'std' => $header_background,
		'type' => 'background' );
		
		$options[] = array(
		'name' =>  __('Footer Fonts Color', 'cubby'),
		...
		'desc' => __('Active custom home page layout.  The standardized way of creating Static Front Pages: <a href="'.esc_url('http://codex.wordpress.org/Creating_a_Static_Front_Page').'" target="_blank">Creating a Static Front Page</a>', 'cubby'),
		'id' => 'enable_home_page',
		'std'=>1,
		'type' => 'checkbox');
