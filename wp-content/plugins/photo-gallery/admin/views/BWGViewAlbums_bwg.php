...
class BWGViewAlbums_bwg {
  ...
  public function display() {
    ...
    <form class="wrap" id="albums_form" method="post" action="admin.php?page=albums_bwg" style="width:95%;">
  ...
  public function edit($id) {
    ...
    <form class="wrap" method="post" action="admin.php?page=albums_bwg" style="width:95%;">
      <span class="album-icon"></span>
