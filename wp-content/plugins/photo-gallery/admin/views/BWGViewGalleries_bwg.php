...
class BWGViewGalleries_bwg {
  ...
  public function display() {
    ...
    <form class="wrap" id="galleries_form" method="post" action="admin.php?page=galleries_bwg" style="width:95%;">
  ...
  public function edit($id) {
    ...
    <form class="wrap" method="post" id="galleries_form" action="admin.php?page=galleries_bwg" style="width:95%;">
      <span class="gallery-icon"></span>
