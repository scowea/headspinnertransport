...
class  BWGViewThemes_bwg {
  ...
  public function display() {
    ...
    <form class="wrap" id="themes_form" method="post" action="admin.php?page=themes_bwg" style="width:95%;">
  ...
  public function edit($id, $reset) {
    ...
    <form class="wrap" method="post" action="admin.php?page=themes_bwg" style="width:99%;">
      <span class="theme_icon"></span>
